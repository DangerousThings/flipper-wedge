...
- Compatible with Official, Unleashed, Xtreme, and RogueMaster firmwares
...
**Built With:**
- Base Template: flipper-zero-fap-boilerplate by leedave
- Flipper Zero Firmware: Official firmware
