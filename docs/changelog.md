...
All notable changes to the Contactless HID Device project will be documented in this file.
...
- **November 2024**: Initial development
  ...
  - Renamed from "Contactless HID Reader" to "Contactless HID Device"
